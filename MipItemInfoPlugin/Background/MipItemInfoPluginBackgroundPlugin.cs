...
namespace MipItemInfoPlugin.Background
{
    /// <summary>
    ...
    /// </summary>
    public class MipItemInfoPluginBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return MipItemInfoPluginDefinition.MipItemInfoPluginBackgroundPlugin; }
        }
        ...
        {
            get { return "MipItemInfoPlugin BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "MipItemInfoPlugin Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "MipItemInfoPlugin background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "MipItemInfoPlugin background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
