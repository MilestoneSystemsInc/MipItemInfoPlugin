...
namespace MipItemInfoPlugin.Client
{
    ...
    /// </summary>
    public partial class MipItemInfoPluginViewItemWpfUserControl : ViewItemWpfUserControl
    {
        #region Component private class variables

        private MipItemInfoPluginViewItemManager _viewItemManager;
        ...
        /// <summary>
		/// Constructs a MipItemInfoPluginViewItemUserControl instance
        /// </summary>
		public MipItemInfoPluginViewItemWpfUserControl(MipItemInfoPluginViewItemManager viewItemManager)
        {
        ...
        private void SetHeaderColors()
        {
            if (Selected)
            {
                _headerGrid.Background = new SolidColorBrush(GetWindowsMediaColor(ClientControl.Instance.Theme.ViewItemSelectedHeaderColor));
                _nameTextBlock.Foreground = new SolidColorBrush(GetWindowsMediaColor(ClientControl.Instance.Theme.ViewItemSelectedHeaderTextColor));
                _headerTextBlock.Foreground = new SolidColorBrush(GetWindowsMediaColor(ClientControl.Instance.Theme.ViewItemSelectedHeaderTextColor));
            }
            else
            {
                _headerGrid.Background = new SolidColorBrush(GetWindowsMediaColor(ClientControl.Instance.Theme.ViewItemHeaderColor));
                _nameTextBlock.Foreground = new SolidColorBrush(GetWindowsMediaColor(ClientControl.Instance.Theme.ViewItemHeaderTextColor));
                _headerTextBlock.Foreground = new SolidColorBrush(GetWindowsMediaColor(ClientControl.Instance.Theme.ViewItemHeaderTextColor));
            }
        }
