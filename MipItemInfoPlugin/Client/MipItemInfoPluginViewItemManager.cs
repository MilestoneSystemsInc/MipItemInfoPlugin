...
namespace MipItemInfoPlugin.Client
{
    ...
    /// </summary>
    public class MipItemInfoPluginViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public MipItemInfoPluginViewItemManager() : base("MipItemInfoPluginViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(MipItemInfoPluginDefinition.MipItemInfoPluginPluginId, null, MipItemInfoPluginDefinition.MipItemInfoPluginKind);
        ...
        //{
        //	return new MipItemInfoPluginViewItemUserControl(this);
        //}
        ...
        {
            return new MipItemInfoPluginViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new MipItemInfoPluginPropertiesUserControl(this);
        //}
        ...
        {
            return new MipItemInfoPluginPropertiesWpfUserControl(this);
        }
