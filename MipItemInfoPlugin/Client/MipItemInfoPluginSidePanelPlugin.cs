...
namespace MipItemInfoPlugin.Client
{
    ...
    /// </summary>
    public class MipItemInfoPluginSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new MipItemInfoPluginSidePanelUserControl();
        //}
        ...
        {
            return new MipItemInfoPluginSidePanelWpfUserControl();
        }
        ...
        {
            get { return MipItemInfoPluginDefinition.MipItemInfoPluginSidePanel; }
        }
        ...
        {
            get { return "MipItemInfoPlugin Side panel"; }
        }
