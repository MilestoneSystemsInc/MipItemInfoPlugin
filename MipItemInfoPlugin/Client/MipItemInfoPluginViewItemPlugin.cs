...
namespace MipItemInfoPlugin.Client
{
    ...
    /// </summary>
    public class MipItemInfoPluginViewItemPlugin : ViewItemPlugin
    {

        public MipItemInfoPluginViewItemPlugin()
        {
        }
        ...
        {
            get { return MipItemInfoPluginDefinition.MipItemInfoPluginViewItemPlugin; }
        }
        ...
        {
            return new MipItemInfoPluginViewItemManager();
        }
