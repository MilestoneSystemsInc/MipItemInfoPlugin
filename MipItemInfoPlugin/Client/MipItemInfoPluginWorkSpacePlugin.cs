...
{
    public class MipItemInfoPluginWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return MipItemInfoPluginDefinition.MipItemInfoPluginWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(1, new MipItemInfoPluginWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
