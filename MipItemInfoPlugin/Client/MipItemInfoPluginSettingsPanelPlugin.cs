...
{
    public class MipItemInfoPluginSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return MipItemInfoPluginDefinition.MipItemInfoPluginSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "MipItemInfoPlugin"; } }
        ...
        {
            _userControl = new MipItemInfoPluginSettingsPanelControl(this);
            return _userControl;
        }
