...
namespace MipItemInfoPlugin.Admin
{
    ...
    /// </summary>
    public class MipItemInfoPluginItemManager : ItemManager
    {
        private MipItemInfoPluginUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public MipItemInfoPluginItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new MipItemInfoPluginUserControl();
        ...
        {
            return new MipItemInfoPluginAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(MipItemInfoPluginDefinition.MipItemInfoPluginPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((MipItemInfoPluginAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(MipItemInfoPluginDefinition.MipItemInfoPluginPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(MipItemInfoPluginDefinition.MipItemInfoPluginPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(MipItemInfoPluginDefinition.MipItemInfoPluginPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(MipItemInfoPluginDefinition.MipItemInfoPluginPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(MipItemInfoPluginDefinition.MipItemInfoPluginPluginId, _kind, fqid.ObjectId);
            return item;
        }
