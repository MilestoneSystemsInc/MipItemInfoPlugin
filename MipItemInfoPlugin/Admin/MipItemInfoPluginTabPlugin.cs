...
{
    public class MipItemInfoPluginTabPlugin : TabPlugin
    {
        ...
        {
            get { return MipItemInfoPluginDefinition.MipItemInfoPluginTabPluginId; }
        }
        ...
        public override TabUserControl GenerateUserControl(Item item)
        {
            ...
            return new MipItemInfoPluginTabUserControl(item);
        }
